...
const char *client_id = "TD02_GP08";
...
void setup()
{
  ...
  {
    mqtt_client.publish("TD02_GP08/temp", String(temp_measure).c_str());
    mqtt_client.publish("TD02_GP08/relhum", String(relative_humidity_measure).c_str());
  }
